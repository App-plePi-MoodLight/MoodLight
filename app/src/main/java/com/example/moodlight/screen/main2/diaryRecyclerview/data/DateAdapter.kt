...
class  DateAdapter(val context: Context, val DataList: ArrayList<DateClass>, val onClick: (data : MyAnswerListModelItem)-> Unit): RecyclerView.Adapter<DateAdapter.MyViewHolder>(){
